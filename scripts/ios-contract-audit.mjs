...
requireText(models, "static let maximumDescriptionLength = 2_000", "Check-in description enforces the 2000-character API limit");
...
requireText(modelTests, "testCheckInDescriptionStopsAboveTwoThousandCharacters", "XCTest covers check-in description length");
